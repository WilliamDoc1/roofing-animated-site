...
export default function IndustrialPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-[#0F2C59] selection:text-white flex flex-col">
          ...
          <div className="glass-panel p-10 md:p-14 rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-100 relative overflow-hidden">
            <div className="max-w-3xl">
              <h1 className="font-heading text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-6">
                Industrial Roofing & <span className="text-[#0F2C59]">Over-Sheeting</span>
              </h1>

              <p className="text-slate-700 text-base md:text-lg leading-relaxed mb-8">
                Sample Roofing (Pty) Ltd specializes in heavy-duty IBR and corrugated steel roof sheet replacement, industrial box gutter relining, over-roofing insulation, and fall protection skylights for manufacturing plants, logistics hubs, and warehouses.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span>Request Industrial Inspection</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="font-heading text-3xl font-extrabold text-slate-900">
                Heavy-Duty Industrial Roofing Solutions
              </h2>
              <p className="text-slate-700 text-sm leading-relaxed">
                Industrial warehouses and manufacturing plants require robust sheeting designed to withstand extreme thermal movement, heavy rain runoff, and structural wind loads.
              </p>

              <div className="space-y-3">
                {[
                  "Heavy gauge 0.58mm Chromadek & Zincalume IBR sheeting",
                  "Over-roofing systems to eliminate costly facility shutdowns",
                  "Factory translucent skylight sheet replacement & safety mesh",
                  "Industrial box gutter relining with 4mm torch-on bitumen",
                  "OHS safety-compliant height safety work protocols",
                  "Written 2-year workmanship guarantee on all industrial projects"
                ].map((item, idx) => (
            ...
            <div className="relative">
              <GalleryPlaceholder
                id="IN-02"
                title="Logistics Park Heavy Metal Over-Sheeting"
                category="Industrial"
                location="Western Cape"
                specs="0.58mm Heavy Gauge Chromadek IBR Sheet"
                year="2025 Completed"
                aspectRatio="16/9"
      ...
      <QuoteModal isOpen={isQuoteOpen} onClose={() => setIsQuoteOpen(false)} defaultService="Industrial Roofing" />
